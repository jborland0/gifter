...
const WishlistTable = ({ wishlist, gifts, propsPageNumber, propsPageSize, pageCount }) => {
	...
	const columns = React.useMemo(() => [
	    { Header: <PlusSquare style={{ cursor: 'pointer' }} onClick={() => wishlist.addGift()} />, accessor: 'id', 
			Cell: props => <PencilSquare style={{ cursor: 'pointer' }} onClick={() => wishlist.editGift(props.value)} /> },
